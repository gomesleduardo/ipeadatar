...
#'
#' @note The names of available series were kept in the original language (Brazilian portuguese).
#'
#' @export
#'
#' @importFrom magrittr %<>%
...
#' @title List with available topics
#'
#' @description Returns a list with topics discussed by Ipeadata database.
#'
#' @usage available_themes()
#'
#' @return A data frame containing the topic code and the topic in Brazilian portuguese.
#'
#' @examples
#' # Countries
...
#' #' the source, the source's name, the source's link, the periodicity of the series, the unity, the multiplier factor,
...
#' #' metadado.serieD <- metadata(all_series$code[1:150], TRUE)XXXXXXXXXXX
#' #'
#' #' @export
#' 
